...
public:
	...
	void LoadFrames(unsigned long offset,  int spriteID, int romType, unsigned char* tileGFX, long* pal, bool NoFrameTable);

	void LoadFrames(unsigned long offset,  int spriteID, int romType);
	...
	FrameManager(GBAMethods* GBA, unsigned long offset,  int spriteID, int romType, bool NoFrameTable = false);
