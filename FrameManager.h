...
public:
	...
	void LoadFrames(unsigned long offset, FILE* ROM, int spriteID, int romType, unsigned char* tileGFX, long* pal);
	...
	FrameManager(GBAMethods* GBA, unsigned long offset, FILE* ROM, int spriteID, int romType);
	FrameManager(GBAMethods* GBA,unsigned long offset, FILE* ROM, int spriteID, int romType, unsigned char* tileGFX, long* pal);
	~FrameManager();
public:
