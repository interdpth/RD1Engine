...
GritInterface::GritInterface(GritRec *gr)
{
...
*/
int GritInterface::grit_parse_cprs(const char *key, const strvec &args)
{
	// compression
...
*/
bool GritInterface::grit_parse_mapsel_format(const char *key, MapselFormat *pmf)
{
...
bool GritInterface::grit_parse_pal(GritRec *gr, const strvec &args)
{
	int val;
	if (CLI_BOOL("-p!") == false)
	{
...
bool GritInterface::grit_parse_gfx(GritRec *gr, const strvec &args)
{
	int val;
	const char *pstr;
...
bool GritInterface::grit_parse_map(GritRec *gr, const strvec &args)
{
	int val;
	const char *pstr;
...
*/
bool GritInterface::grit_parse_file(GritRec *gr, const strvec &args)
{
	int ii;
	char *pstr;
...
*/
int GritInterface::grit_parse_log(GritRec *gr, const strvec &args)
{
	char *pstr = CLI_STR("-W", "");
...
*/
bool GritInterface::grit_parse(GritRec *gr, const strvec &args)
{
	int val;
...
bool GritInterface::grit_parse_shared(GritRec *gr, const strvec &args)
{
	int val;
...
*/
bool GritInterface::grit_load_ext_tiles(GritRec *gr)
{
...
bool GritInterface::grit_save_ext_tiles(GritRec *gr)
{
	GritShared *grs = gr->shared;
...
*/
void GritInterface::args_gather(strvec &args, int argc, char **argv)
{
	/*
...
bool GritInterface::args_validate(const strvec &args, const strvec &fpaths)
{
	bool result = true;
...
void GritInterface::args_set_mode(GritShared *grs, const strvec &args, const strvec &paths)
{
	bool bShared;
...
bool GritInterface::run_prep(GritRec *gr, const char *fpath)
{
	grit_clear(gr);
	grit_init(gr);
...
*/
int GritInterface::run_individual(GritRec *gr, const strvec &args, const strvec &fpaths)
{
	unsigned int ii;
...
/*!	\return 0 if successfull.
*/
int GritInterface::run_shared(GritRec *gr, const strvec &args, const strvec &fpaths)
{
	uint ii;
	GritShared *grs = gr->shared;
...
//! Do a grit run.
GritRec * GritInterface::run_main(int argc, char **argv)
{
	unsigned int ii;
